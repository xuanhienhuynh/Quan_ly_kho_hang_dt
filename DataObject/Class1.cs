...
//        public void INSERTNhapHang (DataTable table, string mathung, string masp, string tensp, int soluong, string ngaynhap, string nguoinhap)
//        {
//            foreach(DataRow r in table.Rows)
//            {
//                if (string.Compare(r["MaThung"].ToString(),mathung) == 0)
//                {
//                    Mess.Show("Trùng mã thùng");
//                    return;
//                }
//            }
